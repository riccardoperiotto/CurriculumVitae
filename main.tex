...
\vspace*{3.49cm}% start 8 cm from the top of the page}
    ...
    \vspace*{1.2cm} % text starts 1cm under the top of the minipage
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % Professional skills 
        \ruleline{\textbf{Technical skills/courses}}
        \begin{center}
            \cvtag{Software Engineering}\cvtag{Control}\cvtag{Industrial Robotics}\cvtag{Machine Learning}\cvtag{Model Predictive Control}\cvtag{Deep Learning}\cvtag{Mechatronics}\cvtag{Algorithms}\cvtag{Data Structure}\cvtag{Sensor Fusion}\cvtag{Database}\cvtag{Dynamic Modeling}\cvtag{Operating Systems}\cvtag{Full Stack Development}
        \end{center}
    \end{minipage}} %
    \hfill 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%% MAIN SECTION %%%%%%%%%%%%%%%%%%%%
    \adjustbox{valign=t}{\begin{minipage}{11.3cm}
        ...
        \begin{itemize}
        \footnotesize
            \item \textbf{ROS2}: basic
            \item \textbf{.NET}: advance
            \item \textbf{Node.js}: advance
            \item \textbf{Unity}: intermediate
            \item \textbf{Scikit-learn}: intermediate
            \item \textbf{Jax}: intermediate
            \item \textbf{SQL}: advance
            \item \textbf{MapleSim}: beginner
            \item \textbf{React.js}: intermediate
            \item \textbf{git}: advance
            \item[\vspace{\fill}]
        \end{itemize}
        \end{multicols}
